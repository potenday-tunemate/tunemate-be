...
public class SearchController {
    ...
    @GetMapping("")
    public ResponseEntity<OkResponse<List<CreateAlbumDTO>>> getSerchAlbum(@RequestBody SearchDTO searchDTO) {
        List<CreateAlbumDTO> searchClubList = searchService.findSearchClub(searchDTO);
        return ResponseEntity.ok(new OkResponse<>(true, searchClubList));
    }
